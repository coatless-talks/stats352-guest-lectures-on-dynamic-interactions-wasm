...
Let's take for example **hello_world.c**
...
We can convert it using Emscripten to web page with:

```sh
emcc hello_world.c -o hello_world.html
```

Previewing `hello_world.html` requires a **local server** to see output.
...
```{=html}
<iframe allow="cross-origin-isolated" width="100%" height="80%" src="https://webr.r-wasm.org/v0.3.3/">
</iframe>
```
...
## Using R in our Browser

:::{.r-fit-text}
:::{.columns}

:::{.column width="55%"}
![](assets/gifs/demo-webr-console.gif){alt="An animated gif that shows the initialization of webR and some calculations within Google Chrome's Developer Tools console." fig-align="center"}
:::

:::{.column width="45%"}

- In our web developer console, we can initialize webR and perform calculations.
- In console, type:
...
![](assets/wasm-images/pyodide-logo.png){alt="The Pyodide Project logo"  fig-align="center"}
...
```{=html}
<iframe allow="cross-origin-isolated" width="100%" height="80%" src="https://pyodide.org/en/stable/console.html">
</iframe>
```
...
```{=html}
<iframe allow="cross-origin-isolated" width="100%" height="80%" src="https://jupyterlite.readthedocs.io/en/stable/_static/lab/index.html">
</iframe>
```
...
```{=html}
<iframe allow="cross-origin-isolated" width="100%" height="80%" src="https://jupyterlite.readthedocs.io/en/stable/_static/notebooks/index.html?path=intro.ipynb">
</iframe>
```
...
```{=html}
<iframe allow="cross-origin-isolated" width="100%" height="80%" src="https://jupyterlite.readthedocs.io/en/stable/_static/repl/index.html?toolbar=1&kernel=python&code=import%20this">
</iframe>
```
...
```{=html}
<iframe allow="cross-origin-isolated" width="100%" height="80%" src="https://marimo.app/">
</iframe>
```
...
::: {.callout-note}
We can substitute the R with Python in these diagrams.
:::
...
- **Universal environments**
  ...
  - Not an exact replica of downloaded software.
...
[![](assets/wasm-images/r-universe-wasm-webr-ggplot2.png){fig-alt="A screenshot showing the webR binary on the r-universe.dev website alongside of an application of webR to download data." fig-align="center"}](https://tidyverse.r-universe.dev/ggplot2)
...
- For {quarto-pyodide}, the extension is relatively new (~Feb 2024)
   ...
   - Rémi Genet's [Introduction to Python (French)](https://remigenet.github.io/Introduction-Python/) (
     [Code adoption](https://github.com/remigenet/Introduction-Python/commit/4f01e38d69287682ebc52dacf125413354a5087e#diff-4bb7e59494d3ed710da3c018cbfeeb68127fb60fb6bda1c491ceaabc82cc40cc))
...
[![](https://github.com/codespaces/badge.svg){fig-alt="Open in GitHub Codespaces" fig-align="center"}](https://codespaces.new/coatless-quarto/quarto-webr-pyodide-demo?quickstart=1)
...
- Improve the `quarto-pyodide` extension features.
  - Move toward a message messaging interface.
...
Questions [{{< fa question size=2x >}}]{style="color:#80221c"}
